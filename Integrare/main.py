...
def discutie(dialogue=None):
    ...
    if ok:
        ...
        with open(path_txt, 'r',encoding='utf-8') as f:
            ...
            for a_line in f:
                lines.append((a_line))
                nrlines+=1
            history += [("[" + localtime + "] Bot", read_data, path_img,lines,images,range(0,nr_images))]
   ...
   # else:
    ...
    #getLatestInputs(history)
    return render_template("finalPage.html", dialogue=getLatestInputs(history))
